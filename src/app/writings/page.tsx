...
export default function Writings() {
  useEffect(() => {
    document.title = "Harry Barnish - Writings";
  }, []);

  const writings: Writing[] = [
    // Add your papers and blogs here
    // Example:
    // {
    //   id: "example-paper",
    //   title: "Example Paper",
    //   date: "12/2025",
    //   description: "An example research paper or blog post.",
    //   type: "paper",
    ...
    <div className="bg-card/50 backdrop-blur-sm rounded-lg border border-border/50 hover:border-primary/30 transition-all duration-300 overflow-hidden">
      ...
      <div className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 space-y-2 sm:space-y-0">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-medium self-start whitespace-nowrap ${
            writing.type === "paper" 
              ? "bg-blue-500/20 text-blue-500" 
              : "bg-purple-500/20 text-purple-500"
          }`}>
            {writing.type === "paper" ? "Paper" : writing.type === "blog" ? "Blog" : "Article"}
          </span>
        </div>
